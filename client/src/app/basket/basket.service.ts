...
export class BasketService {
  ...
  getBasket(username: string){
    return this.http.get<IBasket>(this.baseUrl+'/Basket/GetBasket/jagan').subscribe({
  ...
  private createBasket(): Basket {
    ...
    localStorage.setItem('basket_username', 'jagan'); //TODO: jagan can be replaced with LoggedIn User
    return basket;
  }
